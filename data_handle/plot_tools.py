...
def hgcal_limits():
    plt.axhline(y=(0.476*4096/0.7-440)/64, color='red', linestyle='--')
    plt.text(3, ((0.476+0.015)*4096/0.7-440)/64, 'Layer1', color='red', fontsize=6)
    plt.axhline(y=(0.462*4096/0.7-440)/64, color='red', linestyle='--')
    plt.text(3, ((0.462-0.02)*4096/0.7-440)/64, 'Layer27', color='red', fontsize=6)
    plt.axhline(y=(0.085*4096/0.7-440)/64, color='red', linestyle='--')
    plt.text(3, ((0.085+0.015)*4096/0.7-440)/64, 'Layer1', color='red', fontsize=6)
    plt.axhline(y=(0.076*4096/0.7-440)/64, color='red', linestyle='--')
    plt.text(3, ((0.076-0.02)*4096/0.7-440)/64, 'Layer27', color='red', fontsize=6)
...
def create_heatmap(heatmap, title, gen, seeds=[]):
    ...
    plt.ylabel('r/z')
    plt.scatter([23+int(124*gen.phi_gen/np.pi)-1], [((4096/0.7)*np.tan(2*np.arctan(np.exp(-gen.eta_gen)))-440)/64], 
